...
function calcPressureForElems( p_new, bvc,
    ...
    # Convert arrays to JACCArray
    bvc_d = JACCArray(bvc)
    pbvc_d = JACCArray(pbvc)
    compression_d = JACCArray(compression)
    p_new_d = JACCArray(p_new)
    e_old_d = JACCArray(e_old)
    vnewc_d = JACCArray(vnewc)
